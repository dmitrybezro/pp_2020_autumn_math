...
std::tuple<std::vector<double>, std::vector<int>, std::vector<int>>
getParallelOperations(int size, std::vector<double> Avalues, std::vector<int> Acols,
    std::vector<int> Apointers, std::vector<double> Bvalues, std::vector<int> Bcols, std::vector<int> Bpointers);
std::tuple<std::vector<double>, std::vector<int>, std::vector<int>>
getSequentialOperations(std::vector<double> Avalues, std::vector<int> Acols,
    std::vector<int> Apointers, std::vector<double> Bvalues, std::vector<int> Bcols, std::vector<int> Bpointers);
